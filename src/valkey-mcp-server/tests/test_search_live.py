...
async def _patch_client(client):
    ...
    import awslabs.valkey_mcp_server.tools.search_add_documents as add_mod
    import awslabs.valkey_mcp_server.tools.search_query as query_mod

    # Reset embeddings provider singletons so httpx client uses current event loop
    add_mod._embeddings_provider = None
    query_mod._embeddings_provider = None
